...
const DASHBOARD_TEMPLATES: { key: string; name: string; description: string; widgets: BlueprintWidget[] }[] = [
  ...
  },
  {
    key: "operations",
    name: "Operations",
    description: "A working view: live activity alongside layer/feature statistics.",
    widgets: [
      {
        type: "table",
        title: "Activity",
      ...
      },
      {
        ...
        config: {},
        layout: { desktop: { x: 6, y: 0, w: 3, h: 4 } },
      },
      {
        type: "statistics",
        title: "Feature Statistics",
        dataSourceType: "featureStats",
        config: {},
        layout: { desktop: { x: 9, y: 0, w: 3, h: 4 } },
      },
    ],
  },
  {
